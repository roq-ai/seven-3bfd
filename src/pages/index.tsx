  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the thrill of efficient management with Seven, your ultimate partner for Theme Park Management. Unleash the magic within!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1516051662687-567d7c4e8f6a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0aGVtZSUyMHBhcmt8ZW58MHx8fHwxNjk1NzE2NzM4fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@mattj_bowden?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Matt Bowden`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the thrill of efficient management with Seven, your ultimate partner for Theme Park Management. Unleash the magic within!`}
            </Text>
            <Box
