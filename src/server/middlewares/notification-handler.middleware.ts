...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_created.create': { roles: ['owner', 'manager'], key: 'order', tenantPath: [], userPath: [] },
  'payment_received.create': { roles: ['owner', 'manager'], key: 'payment', tenantPath: [], userPath: [] },
  'inventory_updated.update': { roles: ['owner', 'manager'], key: 'inventory', tenantPath: [], userPath: [] },
};
